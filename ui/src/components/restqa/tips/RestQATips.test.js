...
describe("RestQATips", () => {
  test("render tips", async () => {
    ...
    expect(component.find(".message").text()).toEqual(
      "the tips of the day on https://restqa.io"
    );
    expect(component.find(".message").html()).toMatch(
      '<a href="https://restqa.io" target="_blank">https://restqa.io</a>'
    );
  });
  ...
  test("render default tips if error happen during retrieving", async () => {
    ...
    expect(component.find(".message").text()).toEqual(
      "Share your feedback : https://restqa.io/feedback"
    );
    expect(component.find(".message").html()).toMatch(
      '<a href="https://restqa.io/feedback" target="_blank">https://restqa.io/feedback</a>'
    );
  });
});
