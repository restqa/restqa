      ...
      elements: [
        {
          ...
          steps: [
            ...
            },
            {
              ...
              match: {
                location:
                  "../node_modules/@restqa/restqapi/node_modules/@restqa/plugin/index.js:189",
              },
              result: {
                status: "passed",
                duration: 1000000,
          ...
          steps: [
            ...
            },
            {
              ...
              result: {
                ...
                duration: 0,
                error_message:
                  "AssertionError [ERR_ASSERTION]: [GET /] The response httpCode is invalid, received 500 should be 201\n    + expected - actual\n\n    -500\n    +201\n\n    at Object.Then.httpCode (/Users/olivierodo/WORKS/restqa/restqa/node_modules/@restqa/restqapi/src/restqapi/steps/3-then/functions.js:26:10)",
              },
            },
            {
              arguments: [
...
OUTPUT.RESTQA_COLLECTION = {
  postman:
    "/Users/olivierodo/WORKS/restqa/restqa/example/tests/collections/example-restqa.postman_collection.json",
  insomnia: null,
  hoppscotch: null,
};
...
OUTPUT.RESTQA_PERFORMANCE = ["tests/performances/get.yml"];
