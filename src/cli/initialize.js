  ...
  if (program.y !== true) {
    const questions = [
      ...
      },
      {
        type: "confirm",
        name: "editable",
        message: Locale.get("service.init.questions.editable_dashboard"),
        default: answers.editable
      }
    ]
...
initialize.generate = async function (options) {
  ...
  const {ci, name, url, env, description, folder, telemetry, editable} = options
