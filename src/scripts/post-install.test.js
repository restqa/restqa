...
describe("post-install", () => {
  ...
  test("Share a message to the user to get started with RestQA (global installation)", () => {
    ...
    const expectedOutput = [
      ...
      "",
      "",
      `     Thanks for trusting  ${chalk.green.bold(
        "RestQA"
      )} 🦏 to support you on increasing your ${chalk.bold(
        "Software Quality"
      )}`,
      `           If you like ${chalk.green.bold(
        "RestQA"
      )}, please give us a star ⭐️ on Github`,
      "                                      ---",
  ...
  test("Share a message to the user to get started with RestQA on a windows system(global installation)", () => {
    ...
    const expectedOutput = [
      ...
      `     Thanks for trusting  ${chalk.green.bold(
        "RestQA"
      )} to support you on increasing your ${chalk.bold("Software Quality")}`,
      `            If you like ${chalk.green.bold(
        "RestQA"
